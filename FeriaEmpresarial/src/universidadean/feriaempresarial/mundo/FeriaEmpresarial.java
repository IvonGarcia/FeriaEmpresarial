...
public class FeriaEmpresarial {
    ...
    private int darExpositorresPuesto(int numPuesto, String zona){
        Puesto p = null;
        for (Puesto puesto : puestos){
    ...
    public String metodo1() {
        ...
        String zonaExpositores = "";

     
        int asistentesZona[] = new int[5];
        for (int i = 0; i < 5; i++) {
            asistentesZona[i] = 0;
        }
                    ...
                    if (puestos[i].darNombreEmpresa() == nombreEmpresa) {
                        ...
                        switch (zona) {
                            case Puesto.ZONA_NORTE:
                                asistentesZona[0] += asistentes;
                                break;
                            case Puesto.ZONA_ORIENTE:
                                asistentesZona[1] += asistentes;
                                break;
                            case Puesto.ZONA_SUR:
                                asistentesZona[2] += asistentes;
                                break;
                            case Puesto.ZONA_OCCIDENTE:
                                asistentesZona[3] += asistentes;
                                break;
                            case Puesto.ZONA_CENTRO:
                                asistentesZona[4] += asistentes;
                                break;
                        }
                    }
                }
        ...
        for (int i = 0; i < 5; i++) {
            if (asistentesZona[i] > mayorAsistencia) {
                mayorAsistencia = asistentesZona[i];
                switch (i) {
                    case 0:
